                ...
                <div className="flex flex-col w-[120px] gap-8">
                  <div className="flex flex-col gap-0">
                    ...
                    ${selectedTab === "workspace_general" ? "bg-slate-3" : ""}`}
                      onClick={() => setSelectedTab("workspace_general")}
                    >
                      General
                    </div>
                    <div
                      className={`text-slate-12 text-[13px] hover:bg-slate-3 py-[4px] px-[12px] rounded-md 
                    ${selectedTab === "workspace_members" ? "bg-slate-3" : ""}`}
                      onClick={() => setSelectedTab("workspace_members")}
                    >
                      Members
                    </div>
                  </div>
                  ...
                  <>
                    ...
                    <div className="flex flex-col text-[14px] mt-[16px]">
                      <div className="flex flex-col">
                        ...
                        <div className="flex flex-col gap-4 mt-12 w-[360px]">
                          <label className="text-[14px] w-[120px]">
                            Delete workspace
                          </label>
                          ...
                          <button
                            type="submit"
                            className="bg-red-5 hover:bg-red-6 border-red-7 border text-slate-12 text-[14px] font-medium py-2 px-4 rounded-md self-start"
