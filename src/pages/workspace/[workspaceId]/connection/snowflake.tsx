      ...
      <div className="h-screen bg-slate-1">
        <div className="flex flex-row gap-2 items-center border-b border-slate-4 py-[12px] pl-[12px] pr-[12px] sticky top-0 bg-slate-1 h-[48px]">
          ...
          <div className="h-[18px] w-[18px] flex items-center justify-center">
            <CaretRight size={18} weight="bold" className="text-slate-10" />
          </div>

          <div className="w-[16px] h-[16px]">
            <LogoSnowflake />
          </div>
          <p className="text-slate-12 text-[13px]">Snowflake</p>
        </div>
        <div className="flex flex-col mx-auto w-[640px] text-slate-12 gap-2 mt-[32px]">
            ...
            <div className="flex flex-row justify-end mt-8 gap-4 text-[13px]">
              ...
              <div className="relative inline-block">
                <button
                  ...
                  onMouseEnter={() => setIsHoveringOnAddConnectionButton(true)}
                  onMouseLeave={() => setIsHoveringOnAddConnectionButton(false)}
