        ...
        <tr>
          {Array.from({ length: 20 }, (_, i) => (
            <th
              ...
              className="px-4 py-2 text-left text-white text-[12px] font-normal border-r border-slate-6"
            >
              {columnNames[i]}
            </th>
          ))}
          ...
          <tr key={rowIndex}>
            {row.map((cell, cellIndex) => (
              <td
                ...
                className="px-4 py-2 whitespace-nowrap text-[12px] text-white border-r border-slate-6"
              >
