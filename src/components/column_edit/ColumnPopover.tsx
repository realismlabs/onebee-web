    ...
    <Popover className="flex flex-col">
      {({ open, close }) => (
        <>
          ...
          >
            <Popover.Panel className="absolute z-10 mt-3 px-4 py-3 max-h-[80vh] top-0 rounded-md bg-slate-2 shadow-2xl border border-slate-4 flex flex-shrink w-[260px] flex-col gap-2 items-start justify-start cursor-default">
