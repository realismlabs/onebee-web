...
export const CommandBar = () => {
  ...
  return (
    <div className="absolute inset-0">
      <Command.Dialog open={open} onOpenChange={setOpen} label="Global Command Menu" className="absolute inset-0  left-[50%] translate-x-[-50%] top-20 max-h-[40vh] overflow-y-auto px-12 bg-black text-white shadow-2xl">
