...
function LoaderAnimation() {
  return (
    <>
      <div className="border border-[#FFFFFF10] bg-[#FFFFFF06] rounded-xl h-32 w-32">
        <div
          ...
          >
            <g clipPath="url(#clip0_1002_83860)">
              <g
                id="bottom"
                style={{
                  animation: "loaderFloatUpAndDownBottomStart 1s ease-in-out 0s 1, loaderFloatUpAndDownBottomLoop 4s ease-in-out 1s infinite"
                }}
              >
              ...
              <g
                id="middle"
                style={{
                  animation: "loaderFloatUpAndDownMiddleStart 1s ease-in-out 0s 1, loaderFloatUpAndDownMiddleLoop 4s ease-in-out 1s infinite"
                }}
              >
                <g
                  style={{
                    ...
                    animation: 'scaleUpAndDown2 2s infinite',
              ...
              <g
                id="top"
                style={{
                  animation: "loaderFloatUpAndDownTopStart 1s ease-in-out 0s 1, loaderFloatUpAndDownTopLoop 4s ease-in-out 1s infinite"
                }}
              >
                <g
                  style={{
                    'mixBlendMode': 'overlay',
                    // scale up and down animation
                    animation: 'scaleUpAndDown 2s infinite',
                    transformOrigin: 'center'
                  }}
